...
csv_file = np.genfromtxt ('../timeseries_generation/henon.txt', delimiter="	")
...
f_bifurc = open("Henon/bifurcation.txt", "w")
f_histvisvert = open("Henon/histvisvert.txt", "w")
f_graphdensity = open("Henon/graphdensity.txt", "w")
f_betweenness = open("Henon/betweenness.txt", "w")
f_avgDegree = open("Henon/avgDegree.txt", "w")
f_diameter = open("Henon/diameter.txt", "w")
f_nodes_degree = open("Henon/nodes_degree.txt", "w")
